...
Back in [#19. Definitions of data members and classes/structs](019.md), we got a glimpse of a sytax called *uniform initialization*. We'll explore that, and the reason for it, in this post and the next.
